...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
            ...
            case 3: {
            	shapes.add(count, new MovingSquarePattern(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
                count++;
                break;
            }
            case 4: {
            	shapes.add(count, new MovingQuadPie(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
                count++;
                break;
            }
            case 5: {
            	shapes.add(count, new MovingHeartPattern(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
                count++;
                break;
            }
        }
