 ...
 *  
 *  This program extends JFrame and contains a panel where shapes move around on the screen.
...
public class program extends JFrame {
    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        ImageIcon heartButtonIcon = createImageIcon("heart.gif");
        shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {ovalButtonIcon,recangletButtonIcon,squareButtonIcon,spatternButtonIcon, pieButtonIcon, heartButtonIcon} );
    ...
    protected static ImageIcon createImageIcon(String filename) {
        java.net.URL imgURL = program.class.getResource(filename);
